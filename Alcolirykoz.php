...
<body>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="index.php">Bad Bunny</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item active" href="Alcolirykoz.php">Alcolirykoz</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-5">
                <h1 class="text-center text-danger mt-5">Alcolirykoz - Ninjazz de Aranjuez</h1>
    ...
    <script src="consumidorAlcolirykoz.js"></script>
